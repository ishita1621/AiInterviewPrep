...
export const Step3report = ({ report }) => {
  ...
  console.log('Question Wise Score Data:', questionWiseScore);
  ...
  const downloadPDF=()=>{
    ...
    let advice=" ";
     ...
     doc.save("AI_InterviewReport.pdf");
  ...
  return (
    ...
    from-gray-50 to-blue-50 px-4 sm:px-6 lg:px-10 py-8'>
      ...
      sm:justify-between gap-4'>
        ...
        <div className='mb-10 w-full flex items-start gap-4 flex-wrap'>
          <button
            ...
            className='mt-1 p-3 rounded-full bg-white shadow
                        hover:shadow-md transition'><FaArrowLeft className='text-gray-600' /> </button>
          <div >
        ...
        text-white py-3 px-3 rounded-xl shadow-md transition-all
        duration-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>
          Download PDF
        </button>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          p-6 sm:p-8 text-center'>
            ...
            <h3 className='text-gray-500 mb-4 sm:mb-6
          ...
          p-5 sm:p-8'>
              ...
              <div className='space-y-6'>
                {questionWiseScore.map((q,i)=>(
                  <div key={i} className='bg-gray-50 p-4 sm:p-6
                ...
                sm:items-start gap-3 mb-4'>
                  ...
                  <div className='bg-blue-100 text-blue-600 px-3 py-1
