...
const Pricing = () => {
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            alert("Payment done! Start practicing and ace your interviews.");
            setTimeout(() => {
              navigate("/");
            }, 1000);
          } catch (err) {
  ...
  return (
    <div className='min-h-screen bg-gradirent-to-br
    from-gray-50 to-blue-500 py-16 px-6'>
      <div className='max-w-6xl mx-auto mb-14 flex items-start gap-4'>
        <button
          onClick={() => navigate("/")}
          className='mt-2 p-3 rounded-full bg-white shadow hover:shadow-md
           transition'>
            ...
            return (
              <motion.div key={plan.id}
                ...
                className={`relative rounded-3xl p-8 transition-all
                  duration-300 border ${isSelected ?
